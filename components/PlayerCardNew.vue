<template>
  <div class="relative flex flex-col overflow-hidden group">
    <NuxtLink :to="'/player/' + player.id">
          ...
          <div class="flex items-center justify-between mb-3 leading-3">
            ...
            <div class="flex items-center">
              <img
                ...
                alt=""
                class="w-8 pr-1 bottom-1 sm:z-0 sm:top-1 sm:right-1"
              />
      ...
      <div
        class="absolute z-30 px-4 py-2 rounded-lg shadow-lg right-2 bottom-2 left-2 text-slate-800 bg-slate-100/95"
      >
        <div class="flex pb-1 border-b justify-evenly border-slate-300">
